...
class Movie(models.Model):
    ...
    trailer = models.FileField(upload_to="media/trailers", verbose_name="Kino trayleri")
    banner = models.ImageField(upload_to="media/banners", verbose_name="Kino banneri")
    description = models.TextField(verbose_name="Kino haqida qisqacha")
    year = models.CharField(max_length=10, verbose_name="Kino yili")
    source = models.FileField(upload_to="media/movies", verbose_name="Kino")
